<template>
    ...
    <v-container class="mx-auto mb-0 py-0" elevation="12" fluid style="width: 100%">
            ...
            <v-row v-if="devType == 'Desktop'">
                <v-col cols="12" class="pb-5 mb-0 pl-8 pt-0">
                    <h1 class="text-h6 text-md-h5 font-weight-bold mb-1"><v-icon
                            class="text-h3">mdi-account-multiple</v-icon>&nbsp;Contactos<v-btn color="black"
        ...
        <v-sheet class="mt-5 " elevation="12" height="auto" width="100%">
            ...
            <v-data-table id="cTable" v-model:expanded="expanded" :headers="contactHeaders" :items="allContacts" :search="search"
                :loading="loading"
                    ...
                    <v-toolbar flat style="border-bottom:solid #005D40 5px; background-color: #fff">
                        ...
                        <v-toolbar-title>
                            ...
                            <v-text-field v-model="search" label="Procurar"
                                prepend-inner-icon="mdi-magnify" clearable width="400" density="compact"
