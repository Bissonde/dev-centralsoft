            ...
            <v-card class=" pa-5 pb-8 ma-2" elevation="8" max-width="448" rounded="sm" margin-left="4" style="opacity:0.9;">
              ...
              <br>
                ...
                <v-tabs v-model="tab" color="deep-purple-accent-4" align-tabs="center">
                    ...
                    <v-tab value="two">Segurança</v-tab>
                    <v-tab value="three">Detalhes</v-tab>
                </v-tabs>
                ...
                <v-card-text>
                    <v-window v-model="tab">
                        <v-window-item value="one">
                            ...
                            <v-text-field density="compact" v-model="regEmail.value.value"
                            ...
                            <v-text-field density="compact" v-model="regPhone.value.value"
                                :error-messages="regPhone.errorMessage.value" placeholder="Telemóvel"
                                prepend-inner-icon="mdi-phone-outline" required clearable variant="outlined"></v-text-field>
                    ...
                    Esqueceu a palavra-passe?</a> -->
                            ...
                            <v-text-field :append-inner-icon="visible ? 'mdi-eye-off' : 'mdi-eye'"
                                ...
                                clearable @click:append-inner="visible = !visible"
                    ...
                    Esqueceu a palavra-passe?</a> -->
                        ...
                        <v-window-item value="three">
                            ...
                            <v-combobox  variant="underlined" density="compact" :items=sexCombo v-model="Sex.value.value" clearable
                                    :error-messages="Sex.errorMessage.value" required></v-combobox>


                            <div class="text-subtitle-1 text-medium-emphasis">Data de nascimento</div>
                            <v-text-field  density="compact" v-model="DOB.value.value" clearable
                                        :error-messages="DOB.errorMessage.value" label="Data*" type="date" prepend-inner-icon="mdi-calendar"
                                required></v-text-field>

                            <div class="text-subtitle-1 text-medium-emphasis">Interesses</div>
                            <v-combobox persistent-hint hide-selected :hide-no-data="false" variant="underlined" density="compact" chips v-model="Likes.value.value" clearable
                                            :error-messages="Likes.errorMessage.value" required multiple :items=myInterests></v-combobox>
                        </v-window-item>
                    </v-window>
                </v-card-text>
             ...
             <!-- 
                ...
                <v-checkbox v-model="agreementR.value.value" :error-messages="agreementR.errorMessage.value"
                    color="deep-purple">
                    <template v-slot:label>
                        Concordo aos &nbsp;
                        <a href="#" @click.stop.prevent="dialog = true">Termos de Serviço</a>
                        &nbsp;e&nbsp;
                ...
                <v-btn @click="handleReset" block class="mb-0 rounded-0" color="blue-darken-4" size="large" variant="flat">
