<template>
    ...
    <v-container class="mx-auto mb-0 py-0" elevation="12" fluid style="width: 100%">
            ...
            <v-row v-if="devType == 'Desktop'">
                <v-col cols="12" class="pb-5 mb-0 pl-8 pt-0">
                    <h1 class="text-h6 text-md-h5 font-weight-bold mb-1"><v-icon
                            class="text-h3">mdi-message-plus</v-icon>&nbsp;Mensagens<v-btn color="black" variant="text"
        ...
        <v-sheet class="mt-5 " elevation="12" height="auto" width="100%">
            ...
            <v-data-table id="cTable" v-model:expanded="expanded" :headers="customeMessagesHeaders" :items="allSMS"
                ...
                <template v-slot:item.actions="{ item }">
                    <v-btn color="primary" class="me-2" variant="tonal" icon="mdi-play" density="compact"
                        @click="useModule.dialog = 'Messages'; useModule.title = 'Messages'; editModal = !editModal; isEditing = false; CUSTOMER_MESSAGE_GET(item);"></v-btn>
                    ...
                    <v-btn color="bg-orange-darken-4" class="me-2" variant="text" icon="mdi-pencil-outline"
                        ...
                        @click="useModule.dialog = 'Messages'; useModule.title = 'Messages'; editModal = !editModal; this.isEditing = true; CUSTOMER_MESSAGE_GET(item);"></v-btn>
...
export default {
    ...
    methods: {
        ...
        SMS_GET_ALL: async function (item) {
            ...
            useModule.dialog = 'Messages'
            useModule.name = 'Messages'
            useModule.text = 'Mensagem'
